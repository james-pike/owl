...
export default component$((props: Props) => {
  ...
  const collections = [
    ...
    { id: 6, title: "KasBullz", description: "Horns up, charts up, bullish on KAS 24/7.", image: "/images/KasBULLZCS.png" },
        { id: 2, title: "KasDinoz", description: "Extinct? Nah. They evolved with KAS..", image: "/images/KasDINOZCS.png" },

    { id: 3, title: "KasKatz", description: "Nine lives, one blockdag. Cats land on KAS.", image: "/images/KasDOGZCS.png" },
