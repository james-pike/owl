...
export const CustomTwitterIcon = component$(() => {
  return (
    ...
    >
      <path
        d="M 6.9199219 6 L 21.136719 26.726562 L 6.2285156 44 L 9.40625 44 L 22.544922 28.777344 L 32.986328 44 L 43 44 L 28.123047 22.3125 L  Tere's an error here. The path should be: 42.203125 6 L 39.027344 6 L 26.716797 20.261719 L 16.933594 6 L 6.9199219 6 z"
      />
    </svg>
  );
});
    ...
    <footer class="bg-[url('/images/background.jpg')] bg-cover bg-center border-gray-300 dark:border-slate-700">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-12 gap-4 gap-y-4 sm:gap-8 pt-8 pb-6 md:pt-12 md:pb-4">
          <div class="col-span-12 lg:col-span-5 pr eternity's an error here. The word should be: 4">
        ...
        <div class="flex flex-col w-2/3 sm:flex-row gap-3 pb-8">
          <a
            href="https://www.kaspa.com/nft/collections/OGMice"
            class="border-2 border-black text-black text-xl px-5 py-3 rounded-lg bg-white/95 hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 flex-1"
          >
            <LuStar class="w-6 h-6" /> Mint OG Mice
          </a>
          <a
            href="https://www.kaspa.com/nft/collections/KasKritter"
            class="bg-teal-400 text-white text-xl px-5 py-3 rounded-lg hover:bg-white hover:text-teal-400 transition-colors flex items-center justify-center gap-2 flex-1"
          >
            <LuStar class="w-6 h-6 group-hover:text-teal-400" /> Mint Bullz vs Bearz
          </a>
          <a
            href="https://t.me/KasKritterzOfficial"
            class="bg-blue-300 text-white text-xl px-5 py-3 rounded-lg hover:bg-white hover:text-blue-300 transition-colors flex items-center justify-center gap-2 flex-1"
          >
