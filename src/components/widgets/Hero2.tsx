...
export default component$(() => {
  return (
    <section class="min-h-[calc(100vh-85.66667px)] flex flex-col">
      {/* Hero Text Section */}
      <div class="bg-gradient-to-r from-gray-200 to-gray-50 dark:from-gray-950 dark:to-gray-800 flex items-center px-8 py-12">
        <div>
      ...
      {/* Carousel Section */}
      <div class="bg-red-400 w-full h-[50vh] md:h-full">
        <Carousel />
      </div>
      
      {/* Logo Clouds Section */}
      <div class="bg-gradient-to-r hidden md:block from-gray-200 to-gray-50 dark:from-gray-900 dark:to-gray-700 flex items-center py-6">
        <LogoClouds />
      </div>
    </section>
  );
