...
export default component$(() => {
 ...
 class="bg-teal-400 text-white text-2xl px-6 py-4 rounded-lg hover:bg-teal-300 transition-colors flex items-center gap-2">
            <LuStar class="w-8 h-8" /> Mint <span class="hidden md:block">Now</span>
          </a>
          <button class="bg-blue-300 text-white px-6 text-2xl py-4 rounded-lg hover:bg-blue-200 transition-colors flex items-center gap-2">
            <LuUsers class="w-8 h-8" /> Join <span class="hidden md:block">Community</span> <span class="block md:hidden">Us!</span>
          </button>
        </div>
      </div>
    </section>
