...
export default component$(() => {
  return (
    <section
      class="md:min-h-[90vh] flex items-center bg-[url('/images/mobile2.png')] bg-cover bg-no-repeat md:bg-[url('/images/banner2.png')] bg-[center_35%]"
    >
 ...
 class="bg-teal-400 text-white text-2xl px-6 py-3 rounded-lg hover:bg-teal-300 transition-colors flex items-center gap-2">
            <LuStar class="w-7 h-7" /> Mint <span class="hidden md:block">Now</span>
          </a>
