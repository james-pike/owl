...
const wizardCategories = [
  {
    ...
    images: [
      ...
      {
        src: '/images/lordweapon.png',
        alt: 'Soul Reaper',
        title: 'Skullbrand of the Last Prophet',
        description: 'Staff carved in skulls of the undead.',
        rarity: 0.4,
      },
    ],
  },
  {
    ...
    images: [
      ...
      {
        src: '/images/lordarmor.png',
        alt: 'Infernal Plate',
        title: 'Gold Celestial Wrathcloak',
        description: 'Legendary golden cloak of wrath.',
        rarity: 0.4,
      },
    ],
  },

  {
    ...
    images: [
      ...
      {
        src: '/images/lordhead.png',
        alt: 'Voidstone Amulet',
        title: 'Crown of the Fallen',
        description: 'Golden crown protects from all spirits.',
        rarity: 0.4,
      },
    ],
  },
