                    ...
                    >
                      <div
                        class={twMerge(
                          ...
                          "md:static",
                          "md:border-8",
                          "relative after:content-[''] after:absolute after:w-2 after:bg-teal-400 after:h-[calc(48px/4)] after:left-1/2 after:-translate-x-1/2 after:bottom-0 after:rotate-0 after:z-0 md:after:hidden" // Line down from bottom of circle
                        )}
                      >
                        <span
                          class={twMerge(
