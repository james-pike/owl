...
export const wizardCategories: WizardCategory[] = [
    ...
    images: [
      ...
      { src: '/images/Oneof1/6.jpeg', alt: 'ShaiBull', title: 'Silent Night', description: 'A unique ShaiBull design.', rarity: 0.05 },
      ...
      { src: '/images/Oneof1/9.jpeg', alt: 'KritterKingBear', title: 'Neo Mice', description: 'A unique KritterKingBear design.', rarity: 0.05 },
